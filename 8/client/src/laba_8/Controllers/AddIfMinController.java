...
public class AddIfMinController {
    ...
    @FXML
    private Button turnovetCheck;

    @FXML
    private Button streetCheck;

    @FXML
    private Button zipcodeCheck;

    @FXML
    private Button lxCheck;

    @FXML
    private Button lyCheck;

    @FXML
    private Button townCheck;
    ...
    void initialize() {
        ...
        Receiver.addIfMinController = this;
        ObservableList<String> types = FXCollections.observableArrayList("COMMERCIAL", "PUBLIC", "TRUST", "PRIVATE_LIMITED_COMPANY", "OPEN_JOINT_STOCK_COMPANY");
        ...
        addButton.setOnAction(actionEvent -> {
            ...
            if (final_name != null && final_x != null && final_y != null && final_annualTurnover != null && final_street != null && final_zipcode != null && final_lx != null && final_ly != null && final_town != null && final_type != null) {
                try {
                    ConsoleManager.invoke("add_if_min");
