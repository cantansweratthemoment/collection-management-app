...
import laba_7.Utils.CollectionManager;
...
public class OrganizationsBase {
    ...
    public static void loadCollection(List<Organization> organizations) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            organizations.add(new Organization(resultSet.getInt(1), resultSet.getString(3),
                    ...
                    resultSet.getString(10), new Location(resultSet.getFloat(11), resultSet.getFloat(12), resultSet.getString(13)))));
        }
    }
    ...
    public void addOrganizationToTheBase(Organization organization, int id) {
        if(id==-1) {
            try {
                String sql = "INSERT INTO organizations (owner , name, x, y, creationDate, annualTurnover, organizationType, street, zipCode, location_x, location_y, town) VALUES (?,?,?,?,?,?,?,?,?,?,?,?);";
            ...
            try {
            String sql = "INSERT INTO organizations (id ,owner , name, x, y, creationDate, annualTurnover, organizationType, street, zipCode, location_x, location_y, town) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
